...
class Results                                   SizedBox(height: 20),
...
class _ResultsState extends State<Results> {
  ...
  int? _hoveredIndex; // Track which item is being hovered
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text('Search Results for ${widget.query}',style: TextStyle(color: Colors.orange,fontSize: 28),),
                          ...
                          return MouseRegion(
                            ...
                            child: AnimatedContainer(
                              ...
                              transform: Matrix4.identity()
                                ...
                                ..translate(0.0, _hoveredIndex == index ? -5.0 : 0.0),
                              child: GestureDetector(
                                ...
                                child: Card(
                                  elevation: _hoveredIndex == index ? 8.0 : 2.0,
